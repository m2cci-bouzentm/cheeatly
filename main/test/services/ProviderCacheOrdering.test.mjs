// main/services/__tests__/ProviderCacheOrdering.test.mjs
// Locks in the cache-ordering invariant for custom (OpenAI-compatible)
...
// Replicates the message-assembly logic in streamWithCustom.
// Run: node --test main/services/__tests__/ProviderCacheOrdering.test.mjs

import { test, describe } from 'node:test';
import assert from 'node:assert/strict';

// Mirrors the message assembly in streamWithCustom.
...
describe('provider cache ordering invariant', () => {
  ...
  test('changing context does NOT alter the system prefix', () => {
    ...
    const other = buildMessages(
      'SYS',
      'a totally different and much longer context block',
      'q'
    )[0].content;
